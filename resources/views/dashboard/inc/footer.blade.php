...
<script src="{{ asset('dashboard/js/crud.js') }}"></script>
<script src="{{ asset('dashboard/js/index8.js') }}"></script>
<script src="{{ asset('dashboard/vendor/bootstrap-datepicker/js/bootstrap-datepicker.min.js') }}"></script>

<script src="{{ asset('picture/assets/js/main.js')}}"></script>
