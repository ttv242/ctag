                ...
                <div class="col-lg-10 offset-lg-1">
                    <div
                        ...
                        <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                            <div class="contact_info_image"><img src="{{ asset('ctag/images/contact_1.png') }}" alt></div>
                        ...
                        <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                            <div class="contact_info_image"><img src="{{ asset('ctag/images/contact_2.png') }}" alt></div>
                            <div class="contact_info_content">
                                <div class="contact_info_title">Email</div>
                                <div class="contact_info_text"><a
                                        href="https://preview.colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__"
                                        data-cfemail="f79196848384969b9284b7909a969e9bd994989a">[email&#160;protected]</a>
                                </div>
                            </div>
                        </div>

                        <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                            <div class="contact_info_image"><img src="{{ asset('ctag/images/contact_3.png') }}" alt></div>
                            <div class="contact_info_content">
