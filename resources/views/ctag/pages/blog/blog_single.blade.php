...
@section('content')
    <div class="home">
        <div class="home_background parallax-window" data-parallax="scroll"
            data-image-src="{{ asset('ctag/images/blog_single_background.jpg') }}" data-speed="0.8"></div>
    </div>
                ...
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div class="single_post_text">
                        ...
                        <div class="single_post_quote text-center">
                            <div class="quote_image"><img src="{{ asset('ctag/images/quote.png') }}" alt></div>
                            <div class="quote_text">Quisque sagittis non ex eget vestibulum. Sed nec ultrices dui.
                                Cras et sagittis erat. Maecenas pulvinar, turpis in dictum tincidunt, dolor nibh
                                lacinia lacus.</div>
            ...
            <div class="row">
                <div class="col">
                    <div class="blog_posts d-flex flex-row align-items-start justify-content-between">
                        ...
                        <div class="blog_post">
                            <div class="blog_image" style="background-image:url({{ asset('ctag/images/blog_4.jpg') }})">
                            </div>
                        ...
                        <div class="blog_post">
                            <div class="blog_image" style="background-image:url({{ asset('ctag/images/blog_5.jpg') }})">
                            </div>
                        ...
                        <div class="blog_post">
                            <div class="blog_image" style="background-image:url({{ asset('ctag/images/blog_6.jpg') }})">
                            </div>
